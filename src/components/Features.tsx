...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "To unlock amazing energy, emotional resilience, and elevated mood, use daily for 45 minutes with vocal meditation or 'ommm' humming - even while working!"
    },
    {
