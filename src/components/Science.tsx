    ...
    <section id="how-it-works" className="relative py-16 md:py-20 overflow-hidden" style={{ background: "linear-gradient(180deg, #45413D, #4D4944)" }}>
      ...
      <div className="container mx-auto px-6 md:px-8 max-w-6xl relative z-10">
        ...
        <svg viewBox="0 0 620 290" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[600px] mx-auto mb-16">
          ...
          {/* Outcome cards */}
          {/* Enhanced Focus - Target icon */}
          <g transform="translate(370, 35)"><rect x="0" y="0" width="225" height="46" rx="10" fill="rgba(224,120,32,0.10)" stroke="rgba(224,120,32,0.22)" strokeWidth="1"/><g transform="translate(14, 11)" stroke="#E07820" strokeWidth="1.5" fill="none"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/><line x1="12" y1="2" x2="12" y2="0"/><line x1="12" y1="24" x2="12" y2="22"/><line x1="2" y1="12" x2="0" y2="12"/><line x1="24" y1="12" x2="22" y2="12"/></g><text x="44" y="18" fill="rgba(255,255,255,0.85)" fontSize="12" fontWeight="500">Enhanced Focus</text><text x="44" y="34" fill="rgba(255,255,255,0.5)" fontSize="10" fontWeight="300">Sharper attention</text></g>
          {/* Deep Calm - Heart icon */}
          <g transform="translate(370, 93)"><rect x="0" y="0" width="225" height="46" rx="10" fill="rgba(224,120,32,0.10)" stroke="rgba(224,120,32,0.22)" strokeWidth="1"/><g transform="translate(14, 11)"><circle cx="12" cy="12" r="11" stroke="#E07820" strokeWidth="1.5" fill="none"/><path d="M12 8c-1.5-2.5-5-3-6.5-0.5s0.5 5.5 6.5 10c6-4.5 8-7.5 6.5-10s-5-2-6.5 0.5z" fill="#E07820" opacity="0.8"/></g><text x="44" y="18" fill="rgba(255,255,255,0.85)" fontSize="12" fontWeight="500">Deep Calm</text><text x="44" y="34" fill="rgba(255,255,255,0.5)" fontSize="10" fontWeight="300">Reduced stress</text></g>
          {/* Elevated Mood - Sparkles icon */}
          <g transform="translate(370, 151)"><rect x="0" y="0" width="225" height="46" rx="10" fill="rgba(224,120,32,0.10)" stroke="rgba(224,120,32,0.22)" strokeWidth="1"/><g transform="translate(14, 11)" stroke="#E07820" strokeWidth="1.5" fill="none"><path d="M12 2l2 5 5 2-5 2-2 5-2-5-5-2 5-2z"/><path d="M19 14l1.5 3 3 1.5-3 1.5-1.5 3-1.5-3-3-1.5 3-1.5z"/><path d="M5 16l1 2 2 1-2 1-1 2-1-2-2-1 2-1z"/></g><text x="44" y="18" fill="rgba(255,255,255,0.85)" fontSize="12" fontWeight="500">Elevated Mood</text><text x="44" y="34" fill="rgba(255,255,255,0.5)" fontSize="10" fontWeight="300">Meditation · Dopamine Release</text></g>
          {/* Enhanced Energy - Zap icon */}
          <g transform="translate(370, 209)"><rect x="0" y="0" width="225" height="46" rx="10" fill="rgba(224,120,32,0.10)" stroke="rgba(224,120,32,0.22)" strokeWidth="1"/><g transform="translate(14, 11)" stroke="#E07820" strokeWidth="1.5" fill="none"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10"/></g><text x="44" y="18" fill="rgba(255,255,255,0.85)" fontSize="12" fontWeight="500">Enhanced Energy</text><text x="44" y="34" fill="rgba(255,255,255,0.5)" fontSize="10" fontWeight="300">Increased alertness</text></g>
