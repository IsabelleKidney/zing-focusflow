...
const Science = () => {
  ...
  const stats = [
    ...
    { icon: <Award className="w-8 h-8" />, value: <span className="font-black text-4xl tracking-wide" style={{ fontFamily: 'Arial, sans-serif', letterSpacing: '0.15em' }}>CE</span>, label: "Certified Device" }
  ];
